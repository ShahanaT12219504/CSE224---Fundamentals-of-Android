...
class ContextMenu : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var j1 = findViewById<ImageView>(R.id.imgView)
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        var j3 = findViewById<ImageView>(R.id.imgView)
        return when(item.itemId){
            ...
            R.id.rotate ->{
                ...
                Toast.makeText(this,"Angle changed to 45 degrees", Toast.LENGTH_SHORT).show()
                true
            }
